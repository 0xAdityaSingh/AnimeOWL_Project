...
import 'package:animetv/exceptions/TwistDownException.dart';
import 'package:animetv/pages/error_page/ErrorPage.dart';
import 'package:animetv/pages/root_window/root_window.dart';
import 'package:animetv/providers/NetworkInfoProvider.dart';
...
import 'package:animetv/widgets/InitialLoadingScreen.dart';
            ...
            home: watch(_initDataProvider).when(
              ...
              error: (e, s) {
                ...
                if (e is NoInternetException) {
                  ...
                  message = 'Looks like Anime. is down. Please try again later';
                }
                return ErrorPage(
                  message: message,
                  e: e,
